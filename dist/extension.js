...
const assign = __webpack_require__(5)
...
var utimes = __webpack_require__(19)
...
const u = (__webpack_require__(7).fromCallback)
const mkdirs = u(__webpack_require__(22))
const mkdirsSync = __webpack_require__(24)
...
const fs = __webpack_require__(8)
const path = __webpack_require__(2)
const copyFileSync = __webpack_require__(28)
const mkdir = __webpack_require__(21)
...
const _buff = __webpack_require__(29)(BUF_LENGTH)
...
const file = __webpack_require__(41)
const link = __webpack_require__(42)
const symlink = __webpack_require__(43)
...
const _symlinkPaths = __webpack_require__(44)
const symlinkPaths = _symlinkPaths.symlinkPaths
const symlinkPathsSync = _symlinkPaths.symlinkPathsSync

const _symlinkType = __webpack_require__(45)
...
const path = __webpack_require__(2);
const fs = __webpack_require__(3);
const fse = __webpack_require__(4);
const child_process_1 = __webpack_require__(47);
const moment = __webpack_require__(48);
const upath = __webpack_require__(185);
class Logger {
    static log(message) {
        if (this.channel) {
...
class Paster {
    ...
    static saveAndPaste(editor, imagePath) {
    ...
    static getImagePath(filePath, selectText, folderPathFromConfig, showFilePathConfirmInputBox, filePathConfirmInputBoxMode, callback) {
        // image file name
        let imageFileName = "";
        if (!selectText) {
     ...
     */
    static createImageDirWithImagePath(imagePath) {
        return new Promise((resolve, reject) => {
    ...
    static saveClipboardImageToFileAndGetPath(imagePath, cb) {
        ...
        if (platform === 'win32') {
            ...
            let ascript = (0, child_process_1.spawn)('osascript', [scriptPath, imagePath]);
            ...
            let ascript = (0, child_process_1.spawn)('sh', [scriptPath, imagePath]);
            ascript.on('error', function (e) {
                Logger.showErrorMessage(e);
            });
            ascript.on('exit', function (code, signal) {
     ...
     */
    static renderFilePath(languageId, basePath, imageFilePath, forceUnixStyleSeparator, prefix, suffix) {
        if (basePath) {
    ...
    static replacePathVariable(pathStr, projectRoot, curFilePath, postFunction = (x) => x) {
